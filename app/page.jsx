...
<section className="hero-section-container full-screen ipad-top-space-margin py-0 md-h-1200px sm-h-1000px xl-h-1000px fix-height" style={{backgroundColor: "#252840", minHeight: "800px"}}>
...
<section className="background-position-center-top p-0 sm-background-image-none" style={{backgroundImage: "none", marginTop: "50px", marginBottom: "40px"}}>
...
{/* Duplicate slides for seamless loop marquee support */}
<div className="swiper-slide" style={{transform: "scale(1.5)", display: "flex", justifyContent: "center", alignItems: "center"}}>
<a href="https://www.alphavalue.co.in/" target="_blank"><img src="/images/logos/partners/partner-1.png" className="h-40px xs-h-30px" alt="" /></a>
</div>
...
{/* Duplicate slides for loop mode stability */}
<div className="swiper-slide">
<div className="row align-items-center justify-content-center">
<div className="col-8 col-md-4 col-sm-6 text-center md-mb-30px">
<img alt="" src="/images/ecell-logo(white).png" />
...
<section className="hero-section-container one-third-screen sm-h-500px pb-0 position-relative" style={{backgroundColor: "#252840"}}>
<div className="hero-bg-blur"></div>
